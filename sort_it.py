...
trashes = [pygame.image.load('images/trash_1.png'), pygame.image.load('images/trash_2.png'),
         pygame.image.load('images/trash_3.png'), pygame.image.load('images/trash_4.png')]
...
def menu_rules():
    ...
    while done:
        ...
        if mp[0]>180 and mp[0]<300 and mp[1]>600 and mp[1]<660:
            screen.blit(font.render("Back", 1, (250, 30, 250)), (160, 600))
            back_button = 1
...
punkts = [(174, 140, u'Game', (250, 250, 30), (250, 30, 250), 0),
          (172, 210, u'Rules', (250, 250, 30), (250, 30, 250), 1),
          (186, 280, u'Quit', (250, 250, 30), (250, 30, 250), 2)]
...
while run:
    ...
    for event in pygame.event.get():
        ...
        if mp[0] > 400 and mp[0] <450 and mp[1] > 30 and mp[1] < 80 and event.type == pygame.MOUSEBUTTONDOWN:
            punkts = [(150, 140, u'Resume', (250, 250, 30), (250, 30, 250), 0),
                      (172, 210, u'Rules', (250, 250, 30), (250, 30, 250), 1),
                      (186, 280, u'Quit', (250, 250, 30), (250, 30, 250), 2)]
    ...
    if y < 650:
        ...
        if j == 0 and (x + trashes[j].get_width()/2) < tanks[0].get_width()*3//4 :
            fl = True
        elif j == 1 and 120 < (x + trashes[j].get_width()/2) < tanks[1].get_width()*3//4 + 120:
            fl = True
        elif j == 2 and 240 < (x + trashes[j].get_width()/2) < tanks[2].get_width()*3//4 + 240:
            fl = True
        elif j == 3 and 360 < (x + trashes[j].get_width()/2) < tanks[0].get_width()*3//4 + 360:
            fl = True
